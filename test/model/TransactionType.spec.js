...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrassybackendServerApiDoc.TransactionType();
  });
  ...
  describe('TransactionType', function() {
    it('should create an instance of TransactionType', function() {
      ...
      //var instance = new DrassybackendServerApiDoc.TransactionType();
      //expect(instance).to.be.a(DrassybackendServerApiDoc.TransactionType);
    });
