...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrassybackendServerApiDoc.RenewToken();
  });
  ...
  describe('RenewToken', function() {
    it('should create an instance of RenewToken', function() {
      // uncomment below and update the code to test RenewToken
      //var instance = new DrassybackendServerApiDoc.RenewToken();
      //expect(instance).to.be.a(DrassybackendServerApiDoc.RenewToken);
    });
