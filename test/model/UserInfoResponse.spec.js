...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrassybackendServerApiDoc.UserInfoResponse();
  });
  ...
  describe('UserInfoResponse', function() {
    it('should create an instance of UserInfoResponse', function() {
      ...
      //var instance = new DrassybackendServerApiDoc.UserInfoResponse();
      //expect(instance).to.be.a(DrassybackendServerApiDoc.UserInfoResponse);
    });
