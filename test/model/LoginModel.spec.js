...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrassybackendServerApiDoc.LoginModel();
  });
  ...
  describe('LoginModel', function() {
    it('should create an instance of LoginModel', function() {
      ...
      //var instance = new DrassybackendServerApiDoc.LoginModel();
      //expect(instance).to.be.a(DrassybackendServerApiDoc.LoginModel);
    });
